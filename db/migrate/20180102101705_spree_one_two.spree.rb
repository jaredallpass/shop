...
class SpreeOneTwo < ActiveRecord::Migration[5.0]
  def up
    ...
    add_index :spree_line_items, [:order_id],   name: 'index_spree_line_items_on_order_id' unless index_exists?(:spree_line_items, :order_id)
    add_index :spree_line_items, [:variant_id], name: 'index_spree_line_items_on_variant_id' unless index_exists?(:spree_line_items, :variant_id)
    ...
    add_index :spree_tokenized_permissions, [:permissable_id], name: 'index_tokenized_permissions_on_permissable_id'
    add_index :spree_tokenized_permissions, [:permissable_type], name: 'index_tokenized_permissions_on_permissable_type'
